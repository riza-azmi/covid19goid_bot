...
# Riza Azmi (Puslitbang SDP3I) - https://keybase.io/rizaazmi
...
def regular_choice(update, context):
    ...
    if x == 'A':
        ...
        update.message.reply_text(
            ...
            "Ada lagi yang ingin kamu tanyakan? Kalau ada, ketik *MENU* untuk kembali ke menu utama, atau ketik *SELESAI* bila mau mengakhiri perbincangan kita hari ini..",reply_markup=markup2,parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'C':
        update.message.reply_text(
            ...
            "Kamu mau tahu Rumah Sakit mana saja yang menjadi rujukan? Ketik *G*, atau ada lagi yang ingin kamu tanyakan? Kalau ada, ketik *MENU* untuk kembali ke menu utama, atau ketik *SELESAI* bila mau mengakhiri perbincangan kita hari ini.",reply_markup=markup2,parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'D':
        update.message.reply_text(
        ...
        update.message.reply_text(
            ...
            "Atau kamu bisa ketik *MENU* untuk kembali ke menu utama, atau ketik *SELESAI* bila mau mengakhiri perbincangan kita hari ini.",parse_mode=telegram.ParseMode.MARKDOWN)
        return TYPING_REPLY
    elif x == 'SELESAI':
        update.message.reply_text(
            ...
            "Untuk informasi lebih lanjut dapat kunjungi www.covid19.go.id. \n\nKetik *MENU* jika ingin mengulangi perbincangan kembali.",parse_mode=telegram.ParseMode.MARKDOWN)
    else:
        update.message.reply_text(
            "Jika ada  yang ingin kamu tanyakan ketik *MENU* atau ketik *SELESAI* bila mau mengakhiri perbincangan kita hari ini. ",reply_markup=markup2,parse_mode=telegram.ParseMode.MARKDOWN)
    return CHOOSING
...
def received_information(update, context):
    ...
    if x == 'ACEH':
        ...
        update.message.reply_text(
            ...
            "3. Provinsi Sumatera Barat membuka posko suspect wabah virus Corona untuk pengawasan terhadap orang-orang yang diduga terjangkit. Posko ini berlokasi di lantai 1 Kantor Dinas Kesehatan Sumbar, Jalan Perintis Kemerdekaan No 65 A, Padang.",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'RIAU':
        update.message.reply_text(
            "*RIAU*\n\n"
            "1. RSUD Arifin Achmad, Pekanbaru. Telepon: (0761) 23418, 21618, 21657\n"
            "2. RSUD Puri Husada, Tembilahan. Telepon: (0768) 24563\n"
            "3. RSUD Kota Dumai Telepon: (0765) 440992\n"
            "4. Sambungan telepon layanan terkait wabah virus Corona bagi warga Provinsi Riau melalui nomor (0761) 23810.",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'KEPULAUAN RIAU':
        update.message.reply_text(
            "*KEPULAUAN RIAU*\n\n"
            "1. RSUD Embung Fatimah, Batu Aji, Kota Batam. Telepon: (0778) 364446\n"
            "2. RSBP Batam, Sekupang, Batam. Telepon: (0778) 322046, 322121\n"
            "4. RSUD Provinsi Kepulauan Riau, Tanjungpinang. Telepon: (0771) 7335203\n"
            "5. RSUD Muhammad Sani, Tanjung Balai Karimun, Kabupatan Karimun. Telepon: (0777) 327808",parse_mode=telegram.ParseMode.MARKDOWN)
        ...
        update.message.reply_text(
            ...
            "3. Bandara Depati Amir Pangkal Pinang terkoneksi ke RSUD Depati Hamzah, sementara Bandara HS Hanandjoeddin Belitung terhubung ke RSUD H Marsidi Judono, untuk pelayanan kesehatan apabila diperlukan.",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'SUMATERA SELATAN':
        update.message.reply_text(
            "*SUMATERA SELATAN*\n\n"
            "1. RSUP Dr Mohammad Hoesin, Palembang. Telepon: (0711) 354088, IGD: (0711) 315444\n"
            "2. RS Dr Rivai Abdullah, Kabupaten Banyuasin. Telepon: (0711) 7537201\n"
            "3. RSUD Kayuagung, Ogan Komering Ilir. Telepon: (0712) 323889\n"
            "4. RSUD Lahat. Telepon: (0731) 323080\n"
            "5. RSUD Siti Fatimah, Palembang. Telepon: (0711) 5178883, 5718889",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'BENGKULU':
        update.message.reply_text(
            "*BENGKULU*\n\n"
        ...
        update.message.reply_text(
            ...
            "2. RSUD Dr H Bob Bazar SKM, Kabupaten Lampung Selatan. Telepon: (0727) 322159\n"
        ...
        update.message.reply_text(
            ...
            "3. RS Paru Dr M Goenawan Partowidigdo, Cisarua, Bogor. Telepon: (0251) 8253630\n"
            "4. RSUD R Syamsudin SH, Kota Sukabumi Telepon: (0266) 225180, 225181\n"
            "5. RSUD Kabupaten Indramayu Telepon: (0234) 272655\n"
            "6. RSUD Dr Slamet Garut Telepon: (0262) 232720, (0262) 237791\n"
            "7. RSD Gunung Jati Kota Cirebon Telepon: (0231) 206330, (0231)202441\n"
            "8. RS TK II 03.05.01 Dustira, Kota Cimahi. Telepon: (022) 6652207, (022) 2034446\n"
            "9. RSUD Subang Telepon: (0260) 417442, (0260) 411421\n"
            "\n"
        ...
        update.message.reply_text(
            ...
            "3. RSUD Cengkareng, Cengkareng, Jakarta Barat. Telepon: (021) 54372874\n"
            "4. RS Umum Bhayangkara Tk 1 R Said Sukanto (RS Polri), Jakarta Timur. Telepon: (021) 8093288\n"
            "5. RSUP Persahabatan, Jakarta Timur. Telepon: (021) 4891708\n"
            "6. RSAL Mintoharjo, Jakarta Pusat. Telepon: (021) 5703081\n"
            "7. RSUD Pasar Minggu, Jakarta Selatan. Telepon: (021) 29059999\n"
            "8. RSUP Fatmawati, Jakarta Selatan. Telepon: (021) 7501524\n"
            "\n"
            "Nomor darurat #JakartaTanggapCorona Dinas Kesehatan Provinsi DKI Jakarta di 112 atau Posko Dinas Kesehatan di nomor WA 0813-8837-6955.⁣",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'JAWA TENGAH':
        update.message.reply_text(
            "*JAWA TENGAH*\n\n"
            "1. RSUP dr Kariadi, Semarang. Telepon: (024) 8413476\n"
            "2. RSUD KRMT Wongsonegoro, Kota Semarang. Telepon: (024) 6711500\n"
            "3. RSU Columbia Asia, Semarang. Telepon: (024) 7629999\n"
            "4. RSU Sultan Agung, Semarang. Telepon: (024) 6580019\n"
            "5. RSU St Elizabeth, Semarang. Telepon: (024) 8310035\n"
            "6. RSU Telogorejo, Semarang. Telepon: (024) 86466000\n"
            "7. RSU Tk III Bhakti Wira Tamtama, Kota Semarang. Telepon: (024) 3555944\n"
            "8. RSUD Tugurejo, Semarang. Telepon: (024) 7605297\n"
            "9. RSUP dr Soeradji Tirtonegoro, Klaten. Telepon: (0272) 321041\n"
            "10.RSUD Kraton Kabupaten, Pekalongan. Telepon: (0285) 421621\n"
            "11.RSUD Dr H RM Soeselo, Slawi, Kabupaten Tegal. Telepon: (0283) 491016\n"
            "12.RSUD Dr H Soewondo, Kendal. Telepon: (0294) 381433\n"
            "13.RSUD Prof Dr Margono, Banyumas. Telepon: (0281) 632708\n"
            "14.RSUD Tidar Kota, Magelang. Telepon: (0293) 362260\n"
            "15.RSUD Dr Moewardi, Solo. Telepon: (0271) 634634\n"
            "16.RS Paru Dr Ario Wirawan, Salatiga. Telepon: (0298) 326130\n"
            "17.RSUD Banyumas. Telepon: (0281) 796182\n"
            "18.RSUD Dr Loekmonohadi, Kudus. Telepon: (0291) 431831\n"
            "19.RSUD Kardinah, Tegal. Telepon: (0283) 350377\n"
            "20.RSUD Salatiga. Telepon: (0298) 324074\n"
            "21.RSU Tk IV 04.07.03 dr Asmir, Salatiga Telepon: (0298) 326045\n"
            "22.RSUD Ambarawa Telepon: (0298) 591020\n"
            "23.RSUD Sunan Kalijaga, Demak. Telepon: (0291) 685018\n"
            "24.RSUD dr R Soedjati, Grobogan. Telepon: (0292) 421004\n"
            "25.RSU Bhayangkara, Semarang. Telepon: (024) 6720675\n"
            "26.RSU Tk II dr Seodjono, Magelang. Telepon: (0293) 363061\n"
            "27.RSUD RAA Soewondo, Pati. Telepon: (0295) 381102\n"
            "28.RSUD RA Kartini, Jepara. Telepon: (0291) 591175\n"
            "29.RSUD dr R Soetrasno, Rembang. Telepon: (0295) 691444\n"
            "30.RSUD dr R Soetijono, Blora. Telepon: (0296) 531118\n"
            "31.RSU Mardi Rahayu, Kudus. Telepon: (0291) 438234\n"
            "32.RSUD Bendan, Kota Pekalongan. Telepon: (0285) 437222\n"
            "33.RSUD Kajen, Kabupaten Pekalongan. Telepon: (0285) 385231\n"
            "34.RSUD Batang. Telepon: (0285) 4493034\n"
            "35.RSUD Dr M Ashari, Pemalang. Telepon: (0284) 321614\n"
            "36.RSUD Brebes. Telepon: (0283) 671431\n"
            "37.RSU Islam Harapan Anda, Kota Tegal. Telepon: (0283) 358244\n"
            "38.RSUD Cilacap Telepon: (0282) 533010\n"
            "39.RSUD Hj Anna Lasmanah, Banjarnegara. Telepon: (0286) 591464\n"
            "40.RSUD dr R Goeteng Taroenadibrata, Purbalingga. Telepon: (0281) 891016\n"
            "41.RSUD Setjonegoro, Wonosobo. Telepon: (0286) 321091\n"
            "42.RSUD dr Soedirman, Kabupaten Kebumen. Telepon: (0287) 381101\n"
            "43.RSU Tk III Wijayakusuma, Purwokerto. Telepon: (0281) 633062\n"
            "44.RSUD Kota Surakarta. Telepon: (0271) 715300\n"
            "45.RSUD Ir Soekarno, Sukoharjo. Telepon: (0271) 593118\n"
            "46.RSUD Pandan Arang, Boyolali. Telepon: (0276) 321065\n"
            "47.RSUD Bagas Waras, Klaten. Telepon: (0272) 3359666\n"
            "48.RSUD Soehadi Prijonegoro, Sragen. Telepon: (0271) 891068\n"
            "49.RSUD Karanganyar. Telepon: (0271) 495673\n"
            "50.RSUD Dr Soediran MS, Wonogiri. Telepon: (0273) 321008\n"
            "51.RSU PKU Muhammadiyah, Surakarta. Telepon: (0271) 714578\n"
            "52.RSU Islam, Klaten. Telepon: (0272) 322252\n"
            "53.RS Kasih Ibu, Surakarta. Telepon: (0271) 714422\n"
            "54.RS dr Oen, Surakarta. Telepon: (0271) 643139\n"
            "55.RSU Tk IV Slamet Riyadi, Surakarta. Telepon: (0271) 714656\n"
            "56.RSUD Djojonegoro, Temanggung. Telepon: (0293) 491119\n"
            "57.RSUD Dr Tjitrowardojo, Purworejo. Telepon: (0275) 321118\n"
            "58.RSUD Muntilan, Kabupaten Magelang. Telepon: (0293) 587004\n"
            "\n"
            "Hotline Dinas Kesehatan Jawa Tengah : 024-3580713 dan 082313600560",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'YOGYAKARTA':
        update.message.reply_text(
            "*YOGYAKARTA*\n\n"
            "1. RSUD Kota Yogyakarta. Telepon: (0274) 371195, 386691\n"
            "2. RSUP dr Sardjito, Sleman. Telepon: (0274) 631190, 587333\n"
            "3. RSUD Panembahan Senopati, Bantul. Telepon: (0274) 367381, 367386\n"
            "4. RSUD Wates Telepon: (0274) 773169\n\n"
        ...
        update.message.reply_text(
            ...
            "9. RSUD Dr Iskak, Kabupaten Tulungagung Telepon: (0355) 322609\n"
            "10.RSUD Sidoarjo Telepon: (031) 8961649\n"
            "11.RS Universitas Airlangga Kampus C Universitas Airlangga, Mulyorejo, Surabaya. Telepon: (031) 5916290, 5916287, 58208280\n"
            "\n"
        ...
        update.message.reply_text(
            ...
            "3. RSUD Sultan Imanuddin, Pangkalan Bun. Telepon: (0532) 21404",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'KALIMANTAN SELATAN':
        update.message.reply_text(
            "1. RSUD Ulin Banjarmasin. Telepon: (0511) 3252180\n"
            "2. RSUD H Boejasin Pelaihari, Angsau, Kabupaten Tanah Laut. Telepon: (0512) 21083, IGD (0512) 22009",parse_mode=telegram.ParseMode.MARKDOWN)
        ...
        update.message.reply_text(
            ...
            "4. RSUD Dr Agoesdjam, Ketapang. Telepon: (0534) 3037239\n\n"
        ...
        update.message.reply_text(
            ...
            "4. RSUD Kabupaten Buleleng, Singaraja. Telepon: (0362) 22046, 3307744",parse_mode=telegram.ParseMode.MARKDOWN)
        ...
        update.message.reply_text(
            ...
            "3. RSUD Komodo Labuan Bajo, Kabupaten Manggarai Barat. Telepon: 081337055250",parse_mode=telegram.ParseMode.MARKDOWN)
    elif x == 'MALUKU':
        update.message.reply_text(
            "*MALUKU*\n\n"
...
def main():
    updater = Updater("BOTTOKEN:MASUKKANDISINI", use_context=True)
